...
MODULE_PROMPTS = {
    "salud": "\n\nCONTEXTO ACTUAL: El usuario está viendo el dashboard de Salud del agente (visión global del negocio). Enfoca las respuestas en KPIs consolidados, exposición por beneficiario, distribución por afianzadora y top fiados. Si preguntan por cobranza específica o pipeline, responde igual pero sugiere abrir el módulo respectivo al final.",
